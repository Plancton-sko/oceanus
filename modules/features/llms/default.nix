{ self, inputs, ... }:
{
  flake.nixosModules.${vars.username}Llms =
    {
      pkgs,
      lib,
      config,
      ...
      home-manager.users.${vars.username} =
        { config, ... }:
        {
          ...
          home.file.".pi/agent/models.json".source =
            config.lib.file.mkOutOfStoreSymlink "/home/plancton/dev/rice/oceanus/modules/features/llms/models.json";

          home.file.".hermes/config.yaml".source =
            config.lib.file.mkOutOfStoreSymlink "/home/plancton/dev/rice/oceanus/modules/features/llms/hermes-config.yaml";

          home.file.".hermes/SOUL.md".source =
            config.lib.file.mkOutOfStoreSymlink "/home/plancton/dev/rice/oceanus/modules/features/llms/hermes-SOUL.md";
