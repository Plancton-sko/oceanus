...
in
{
  ...
  flake.nixosModules.planctonTheming =
    {
      config,
      pkgs,
      lib,
      ...
      home-manager.users.plancton =
        ...
        in
        {
          ...
          xdg.configFile = {
            ...
            "gtk-3.0/colors.css.template".source =
              mkOutOfStoreSymlink "${theming}/.config/gtk-3.0/colors.css.template";
            ...
            "gtk-4.0/colors.css.template".source =
              mkOutOfStoreSymlink "${theming}/.config/gtk-4.0/colors.css.template";
            ...
            "Kvantum/kvantum.kvconfig".source =
              mkOutOfStoreSymlink "${theming}/.config/Kvantum/kvantum.kvconfig";
            ...
            "qt5ct/style-colors.conf.template".source =
              mkOutOfStoreSymlink "${theming}/.config/qt5ct/style-colors.conf.template";
            ...
            "qt6ct/style-colors.conf.template".source =
              mkOutOfStoreSymlink "${theming}/.config/qt6ct/style-colors.conf.template";
            ...
            "color-schemes/Kvantum.colors.template".source =
              mkOutOfStoreSymlink "${theming}/.config/color-schemes/Kvantum.colors.template";
          ...
          home.activation.copyPapirusIcons = lib.mkAfter ''
            if [ ! -d "$HOME/.local/share/icons/Papirus-Light" ]; then
              ...
              cp -rL ${pkgs.papirus-icon-theme}/share/icons/Papirus-Light "$HOME/.local/share/icons/Papirus-Light"
              chmod -R u+w "$HOME/.local/share/icons/Papirus"
              chmod -R u+w "$HOME/.local/share/icons/Papirus-Dark"
              chmod -R u+w "$HOME/.local/share/icons/Papirus-Light"
            fi
          '';
        };
    };
